    ...
    for attacker in attack:
        for defender in active.sprites():
            ...
            for a_image_position in attack_images:
                ...
                #attack_rect.left = attacker.movement.position.x + image_position.x + collide_frame.max[0]
                a_image = assets.spritesheets[a_image_position.spritesheet].images[a_image_position.image_number]
                attack_rect.left = attacker.movement.position.x + a_image_position.x #- collide_frame.max[0]
                ...
                for d_image_position in defender_images:
                    ...
                    for x, y in collide_frame:
                        ...
                        attack_x = attacker.movement.position.x + a_image_position.x + x
                        attack_y = attacker.movement.position.y + a_image_position.y + y
